...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data Mahasiswa Mahasiswi</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href=" 4" target="_blank"><i class="bi bi-github fs-3"></i></a>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style=""></i> by <a href="https://www.instagram.com/tri_handhono?igsh=ZGNjOWZkYTE3MQ==" target="_blank" style="">Tri Handhono</a></p>
    </footer>
    <!-- Close Footer -->
