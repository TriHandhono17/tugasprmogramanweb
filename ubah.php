...
<head>
    ...
    <title>Tambah Data | TRI HANDHONO | CRUD</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">TRI HANDHONO | CRUD</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Mahasiswa Mahasiswi</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="Teknik Informatika" <?php if ($siswa['jurusan'] == 'Teknik Informatika') { ?> selected='' <?php } ?>>Teknik Informatika</option>
                            <option value="Teknik Sipil" <?php if ($siswa['jurusan'] == 'Teknik Sipil') { ?> selected='' <?php } ?>>Teknik Sipil</option>
                            <option value="Teknik Elektro" <?php if ($siswa['jurusan'] == 'Teknik Elektro') { ?> selected='' <?php } ?>>Teknik Elektro</option>
                            <option value="Desain Komunikasi Visual" <?php if ($siswa['jurusan'] == 'Desain Komunikasi Visual') { ?> selected='' <?php } ?>>Desain Komunikasi Visual</option>
                        </select>
                    </div>
                    <div class="mb-3">
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2">
                ...
                <p>Aplikasi ini dikembangkan untuk memudahkan data mahasiswa mahasiswi Unisnu Jepara</p>
                <p>Tri Handhono</p>
            </div>
            <div class="col-md-6 my-2 text-center link">
                ...
                <a href="https://www.instagram.com/tri_handhono?igsh=ZGNjOWZkYTE3MQ==" target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href=" " target="_blank"><i class="bi bi-twitter fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with  by <a href="https://www.instagram.com/tri_handhono?igsh=ZGNjOWZkYTE3MQ==" target="_blank" style="color: #fff;">Tri handhono</a></p>
    </footer>
    <!-- Close Footer -->
